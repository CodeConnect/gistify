//------------------------------------------------------------------------------
// <copyright file="GistifyCommandPackage.cs" company="Company">
...
namespace CodeConnect.Gistify.Extension
{
    ...
    {
        /// <summary>
        /// GistifyCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "3bea2f42-df82-4e1c-93db-590aa082fbca";

        /// <summary>
        /// Initializes a new instance of the <see cref="GistifyCommand"/> class.
        /// </summary>
        public GistifyCommandPackage()
        {
